          ...
          <div class="jumbotron">
            <h2 class="orderHeader">Оформление заказа</h2>
              <div class="container">
                ...
                @endif
                  <form class="form-horizontal" method="post" action="/catalog/phones/phoneOrder">
    ...
    <div class="col-md-4">
      <div class="right_coll">
          <h2 ">Вы оформляете:</h2>
            <div class="row">
              <div class="col-md-4">
                <img lass="img-rounded" src="/tmp/cut-{{$phones['phonesImg']}}" alt="товар">
              </div>
              <div class="col-md-4 phoneNameOrder">
                <p><h4>{{$phones['phonesName']}}</h4><p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4">
                <p class="summaOrder"> Сумма: {{$phones['phonesPrice']}}</p>
              </div>
            </div>
        </div>
    </div>
